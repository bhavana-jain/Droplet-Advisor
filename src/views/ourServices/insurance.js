		...
		return (
			<div className="container">
				...
				<div className="services-blocks">
					...
					<p>Term Insurance is a type of life insurance policy that provides coverage for a certain period of time, or a specified “term” of years. If the insured dies during the period specified in the policy and the policy is active, or in force, then a death benefit will be paid.</p>
